...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/goods/show"><i class="fa fa-users fa-fw"></i>订单管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/goods/show"><i class="fa fa-sliders fa-fw"></i>客服管理</a></li>
